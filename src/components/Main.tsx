          ...
          <div className="bg-white rounded-2xl shadow-xl p-4 sm:p-6 lg:p-8">
            ...
            <div className="space-y-4 sm:space-y-6 lg:space-y-8">
              <div className="bg-gradient-to-r from-blue-50 to-transparent p-3 sm:p-4 lg:p-6 rounded-xl">
                <h3 className="text-md sm:text-lg lg:text-xl font-semibold text-blue-600 mb-2 sm:mb-3 lg:mb-4">
                  {t.skills.sections.frontend}
                </h3>
                <ul className="grid grid-cols-3 sm:grid-cols-4 gap-2 sm:gap-4 lg:gap-6 place-items-center">
                  {[html, css, js, ts, react, redux, bootstrap].map((tech, index) => (
                    <li key={index} className="w-8 h-8 sm:w-10 sm:h-10 lg:w-12 lg:h-12 transition-all hover:scale-110 hover:-translate-y-1">
                      <img 
                        src={tech} 
              ...
              <div className="bg-gradient-to-l from-purple-50 to-transparent p-3 sm:p-4 lg:p-6 rounded-xl">
                <h3 className="text-md sm:text-lg lg:text-xl font-semibold text-purple-600 mb-2 sm:mb-3 lg:mb-4">
                  {t.skills.sections.backend}
                </h3>
                <ul className="grid grid-cols-3 gap-2 sm:gap-4 lg:gap-6 place-items-center">
              ...
              <div className="bg-gradient-to-r from-green-50 to-transparent p-3 sm:p-4 lg:p-6 rounded-xl">
                <h3 className="text-md sm:text-lg lg:text-xl font-semibold text-green-600 mb-2 sm:mb-3 lg:mb-4">
                  {t.skills.sections.tools}
                </h3>
                <ul className="grid grid-cols-3 gap-2 sm:gap-4 lg:gap-6 place-items-center">
                  <li className="w-8 h-8 sm:w-10 sm:h-10 lg:w-12 lg:h-12 transition-all hover:scale-110 hover:-translate-y-1">
                    <img 
                      src={wix} 
                      alt="Wix"
                      className="w-full h-full object-contain"
        ...
        <section className="bg-white rounded-2xl shadow-xl p-4 sm:p-6 lg:p-8">
          ...
          <div className="space-y-4 sm:space-y-6 lg:space-y-8">
            <div className="bg-gradient-to-r from-blue-50 via-blue-50 to-transparent p-3 sm:p-4 lg:p-6 rounded-xl">
              <h3 className="text-md sm:text-lg lg:text-2xl font-semibold text-blue-600 mb-2 sm:mb-3 lg:mb-4 flex items-center gap-3">
              ...
              <ul className="space-y-2 sm:space-y-3 lg:space-y-4 text-gray-700">
                {t.skills.technicalSkills.frontend.items.map((item, index) => (
                  <li key={index} className="flex items-start gap-1 sm:gap-2 lg:gap-3">
                    <span className="text-blue-500 text-md sm:text-lg lg:text-xl">•</span>
            ...
            <div className="bg-gradient-to-l from-purple-50 via-purple-50 to-transparent p-3 sm:p-4 lg:p-6 rounded-xl ml-auto w-full sm:w-[90%]">
              <h3 className="text-md sm:text-lg lg:text-2xl font-semibold text-purple-600 mb-2 sm:mb-3 lg:mb-4 flex items-center gap-3">
                {t.skills.technicalSkills.backend.title}
              </h3>
              <ul className="space-y-2 sm:space-y-3 lg:space-y-4 text-gray-700">
                {t.skills.technicalSkills.backend.items.map((item, index) => (
                  <li key={index} className="flex items-start gap-1 sm:gap-2 lg:gap-3">
                    <span className="text-purple-500 text-md sm:text-lg lg:text-xl">•</span>
                    <span className="text-xs sm:text-sm lg:text-base">{item}</span>
                  </li>
                ))}
              </ul>
            ...
            <div className="bg-gradient-to-r from-green-50 via-green-50 to-transparent p-3 sm:p-4 lg:p-6 rounded-xl">
              <h3 className="text-md sm:text-lg lg:text-2xl font-semibold text-green-600 mb-2 sm:mb-3 lg:mb-4 flex items-center gap-3">
                {t.skills.technicalSkills.tools.title}
              </h3>
              <ul className="space-y-2 sm:space-y-3 lg:space-y-4 text-gray-700">
                {t.skills.technicalSkills.tools.items.map((item, index) => (
                  <li key={index} className="flex items-start gap-1 sm:gap-2 lg:gap-3">
                    <span className="text-green-500 text-md sm:text-lg lg:text-xl">•</span>
                    <span className="text-xs sm:text-sm lg:text-base">{item}</span>
                  </li>
                ))}
              </ul>
            ...
            <div className="bg-gradient-to-l from-orange-50 via-orange-50 to-transparent p-3 sm:p-4 lg:p-6 rounded-xl ml-auto w-full sm:w-[90%]">
              <h3 className="text-md sm:text-lg lg:text-2xl font-semibold text-orange-600 mb-2 sm:mb-3 lg:mb-4 flex items-center gap-3">
                {t.skills.technicalSkills.webdesign.title}
              </h3>
              <ul className="space-y-2 sm:space-y-3 lg:space-y-4 text-gray-700">
                {t.skills.technicalSkills.webdesign.items.map((item, index) => (
                  <li key={index} className="flex items-start gap-1 sm:gap-2 lg:gap-3">
                    <span className="text-orange-500 text-md sm:text-lg lg:text-xl">•</span>
                    <span className="text-xs sm:text-sm lg:text-base">{item}</span>
                  </li>
                ))}
              </ul>
