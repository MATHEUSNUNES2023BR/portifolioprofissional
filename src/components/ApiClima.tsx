...
function ApiClima(){
  ...
  return(
    <div className='w-full sm:max-w-md bg-white/90 backdrop-blur-sm rounded-xl shadow-lg p-6 font-["Poppins"] text-gray-800 hover:shadow-xl transition-all duration-300'>
      ...
      {activator ? (
        ...
        <div className='space-y-6 animate-fade-in'>
          ...
          <div className='flex flex-col items-center justify-center gap-3 hover:transform hover:scale-105 transition-transform duration-300 sm:flex-row'>
